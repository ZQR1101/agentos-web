...
const labels: Record<TaskStatus, string> = { waiting_approval: "等待审批", paused: "已暂停", running: "执行中", completed: "已完成", failed: "失败", cancelled: "已取消" };
